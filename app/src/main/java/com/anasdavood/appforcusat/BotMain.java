...
public class BotMain extends AppCompatActivity {

    private static final String TAG = BotMain.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bot_main);
...
//        initChatbot();
    ...
    private void initChatbot() {
        final AIConfiguration config = new AIConfiguration("111859572635723459262",
    ...
    private void sendMessage(View view) {
        ...
        if (msg.trim().isEmpty()) {
            Toast.makeText(BotMain.this, "Please enter your query!", Toast.LENGTH_LONG).show();
        } else {
...
//            requestTask.execute(aiRequest);
            ...
            new RequestJavaV2Task(BotMain.this, session, sessionsClient, queryInput).execute();
        }
    }
    ...
    FrameLayout getUserLayout() {
        LayoutInflater inflater = LayoutInflater.from(BotMain.this);
